...
namespace PerfumeStore.Infrastructure.Migrations
{
    ...
    [Migration("20260526092036_AddPromos")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PerfumeStore.Domain.Entities.Accessory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PerfumeStore.Domain.Entities.AccessoryVariant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AccessoryVariants", (string)null);
                });

            modelBuilder.Entity("PerfumeStore.Domain.Entities.BlogArticle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PerfumeStore.Domain.Entities.ContactMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PerfumeStore.Domain.Entities.HomeBanner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PerfumeStore.Domain.Entities.NewsletterSubscriber", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PerfumeStore.Domain.Entities.Product", b =>
                {
                    ...
                    b.Property<bool>("IsMonthlyFeatured")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("PerfumeStore.Domain.Entities.Promo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PerfumeStore.Domain.Entities.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PerfumeStore.Domain.Entities.WishlistItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PerfumeStore.Domain.Entities.AccessoryVariant", b =>
                {
                    b.HasOne("PerfumeStore.Domain.Entities.Accessory", "Accessory")
                        .WithMany("Variants")
            ...
            modelBuilder.Entity("PerfumeStore.Domain.Entities.Review", b =>
                {
                    b.HasOne("PerfumeStore.Domain.Entities.Identity.AppUser", "AppUser")
                        .WithMany()
